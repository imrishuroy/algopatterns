...
const DPTreeVisualizer = dynamic(
  () => import("@/components/visualizers/DPTreeVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const DPTransformationVisualizer = dynamic(
  () => import("@/components/visualizers/DPTransformationVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const DPTableVisualizer = dynamic(
  () => import("@/components/visualizers/DPTableVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const DPJourneyVisualizer = dynamic(
  () => import("@/components/visualizers/DPJourneyVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const DPComparisonVisualizer = dynamic(
  () => import("@/components/visualizers/DPComparisonVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const RecurrenceBuilderVisualizer = dynamic(
  () => import("@/components/visualizers/RecurrenceBuilderVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const ActivitySelectionVisualizer = dynamic(
  () => import("@/components/visualizers/ActivitySelectionVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const JumpGameVisualizer = dynamic(
  () => import("@/components/visualizers/JumpGameVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const GridBFSVisualizer = dynamic(
  () => import("@/components/visualizers/GridBFSVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const TopologicalSortVisualizer = dynamic(
  () => import("@/components/visualizers/TopologicalSortVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const DijkstraVisualizer = dynamic(
  () => import("@/components/visualizers/DijkstraVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const TwoSumVisualizer = dynamic(
  () => import("@/components/visualizers/TwoSumVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const AnagramGroupVisualizer = dynamic(
  () => import("@/components/visualizers/AnagramGroupVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const ConsecutiveSequenceVisualizer = dynamic(
  () => import("@/components/visualizers/ConsecutiveSequenceVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const KthLargestVisualizer = dynamic(
...
const MergeKListsVisualizer = dynamic(
  () => import("@/components/visualizers/MergeKListsVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const MergeIntervalsVisualizer = dynamic(
  () => import("@/components/visualizers/MergeIntervalsVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
...
const IntervalIntersectionVisualizer = dynamic(
  () => import("@/components/visualizers/IntervalIntersectionVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const LinkedListReversalVisualizer = dynamic(
  () => import("@/components/visualizers/LinkedListReversalVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const CycleDetectionVisualizer = dynamic(
  () => import("@/components/visualizers/CycleDetectionVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const ReorderListVisualizer = dynamic(
  () => import("@/components/visualizers/ReorderListVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const PrefixSumVisualizer = dynamic(
  () => import("@/components/visualizers/PrefixSumVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const SubarraySumKVisualizer = dynamic(
  () => import("@/components/visualizers/SubarraySumKVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const ProductExceptSelfVisualizer = dynamic(
  () => import("@/components/visualizers/ProductExceptSelfVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const FixedWindowVisualizer = dynamic(
  () => import("@/components/visualizers/FixedWindowVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const LongestSubstringVisualizer = dynamic(
  () => import("@/components/visualizers/LongestSubstringVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const FindAnagramsVisualizer = dynamic(
  () => import("@/components/visualizers/FindAnagramsVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const ValidParenthesesVisualizer = dynamic(
  () => import("@/components/visualizers/ValidParenthesesVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const NextGreaterVisualizer = dynamic(
  () => import("@/components/visualizers/NextGreaterVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const LargestRectangleVisualizer = dynamic(
  () => import("@/components/visualizers/LargestRectangleVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const TreeTraversalVisualizer = dynamic(
  () => import("@/components/visualizers/TreeTraversalVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const LevelOrderVisualizer = dynamic(
  () => import("@/components/visualizers/LevelOrderVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const BSTValidationVisualizer = dynamic(
  () => import("@/components/visualizers/BSTValidationVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const TrieInsertVisualizer = dynamic(
  () => import("@/components/visualizers/TrieInsertVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const TrieSearchVisualizer = dynamic(
...
const ContainerWaterVisualizer = dynamic(
  () => import("@/components/visualizers/ContainerWaterVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const RemoveDuplicatesVisualizer = dynamic(
  () => import("@/components/visualizers/RemoveDuplicatesVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const UnionFindVisualizer = dynamic(
  () => import("@/components/visualizers/UnionFindVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const ConnectedComponentsVisualizer = dynamic(
  () => import("@/components/visualizers/ConnectedComponentsVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const TwoSumHashMapVisualizer = dynamic(
  () => import("@/components/visualizers/TwoSumHashMapVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const KadaneVisualizer = dynamic(
  () => import("@/components/visualizers/KadaneVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const PrefixSumArrayVisualizer = dynamic(
  () => import("@/components/visualizers/PrefixSumArrayVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const SubsetsVisualizer = dynamic(
  () => import("@/components/visualizers/SubsetsVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const PermutationsVisualizer = dynamic(
  () => import("@/components/visualizers/PermutationsVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
...
const BinarySearchVisualizer = dynamic(
  () => import("@/components/visualizers/BinarySearchVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const RotatedArrayVisualizer = dynamic(
  () => import("@/components/visualizers/RotatedArrayVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const KokoEatingVisualizer = dynamic(
  () => import("@/components/visualizers/KokoEatingVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const ClimbingStairsVisualizer = dynamic(
  () => import("@/components/visualizers/ClimbingStairsVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const HouseRobberVisualizer = dynamic(
  () => import("@/components/visualizers/HouseRobberVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const KnapsackDPVisualizer = dynamic(
  () => import("@/components/visualizers/KnapsackDPVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const CoinChangeVisualizer = dynamic(
  () => import("@/components/visualizers/CoinChangeVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
const LCSVisualizer = dynamic(
  () => import("@/components/visualizers/LCSVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
...
const PalindromeDPVisualizer = dynamic(
  () => import("@/components/visualizers/PalindromeDPVisualizer"),
  { loading: VisualizerLoading, ssr: false }
);
  ...
  return (
    <>
      ...
      {cat === "Dynamic Programming" &&
        title.includes("How DP is Discovered") && (
          <div className="mt-8">
      ...
      {cat === "Dynamic Programming" &&
        title.includes("Deriving Recurrence") && (
          <div className="mt-8">
            <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
              <span className="text-purple-400">▶</span> Interactive Recurrence
              Builder
            </h4>
      ...
      {cat === "Dynamic Programming" &&
        title.includes("Complete DP Transformation") && (
      ...
      {cat === "Dynamic Programming" && title.includes("1D DP") && (
        <div className="mt-8">
          <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            <span className="text-green-400">▶</span> Interactive Climbing
            Stairs
          </h4>
      ...
      {cat === "Dynamic Programming" &&
        title.includes("Unbounded Knapsack") && (
          <div className="mt-8">
            <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
      ...
      {cat === "Graphs" &&
        (title.includes("Grid") ||
          title.includes("Islands") ||
          title.includes("DFS vs BFS")) && (
          <div className="mt-8">
            <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
      ...
      {cat === "Graphs" &&
        (title.includes("Topological") || title.includes("Course")) && (
          <div className="mt-8">
            <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
              <span className="text-purple-400">▶</span> Interactive Topological
              Sort
            </h4>
      ...
      {cat === "Graphs" &&
        (title.includes("Dijkstra") || title.includes("Weighted")) && (
          <div className="mt-8">
            <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
      ...
      {cat === "Hash Map / Set" &&
        (title.includes("Two Sum") || title.includes("Complement")) && (
          <div className="mt-8">
            <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
      ...
      {cat === "Hash Map / Set" &&
        (title.includes("Grouping") || title.includes("Anagram")) && (
          <div className="mt-8">
            <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
              <span className="text-indigo-400">▶</span> Interactive Anagram
              Grouping
            </h4>
      ...
      {cat === "Hash Map / Set" &&
        (title.includes("Consecutive") || title.includes("Sequence")) && (
          <div className="mt-8">
            <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
              <span className="text-teal-400">▶</span> Interactive Consecutive
              Sequence
            </h4>
      ...
      {cat === "Heap / Priority Queue" &&
        (title.includes("Merge K") || title.includes("Merging")) && (
          <div className="mt-8">
            <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
              <span className="text-violet-400">▶</span> Interactive Merge K
              Lists
            </h4>
      ...
      {cat === "Intervals" &&
        ...
        !title.includes("K") && (
          <div className="mt-8">
            <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
              <span className="text-emerald-400">▶</span> Interactive Merge
              Intervals
            </h4>
      ...
      {cat === "Intervals" &&
        (title.includes("Meeting") || title.includes("Line Sweep")) && (
          <div className="mt-8">
            <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
              <span className="text-indigo-400">▶</span> Interactive Meeting
              Rooms
            </h4>
      ...
      {cat === "Intervals" && title.includes("Intersection") && (
        <div className="mt-8">
          <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            <span className="text-cyan-400">▶</span> Interactive Interval
            Intersection
          </h4>
      ...
      {cat === "Linked List" &&
        (title.includes("Reversal") ||
          (title.includes("Reverse") && !title.includes("k-Group"))) && (
          <div className="mt-8">
            <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
              <span className="text-blue-400">▶</span> Interactive Linked List
              Reversal
            </h4>
      ...
      {cat === "Linked List" &&
        (title.includes("Fast/Slow") ||
          title.includes("Floyd") ||
      ...
      {cat === "Linked List" &&
        (title.includes("Reorder") || title.includes("Combining")) && (
          <div className="mt-8">
            <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
              <span className="text-purple-400">▶</span> Interactive Reorder
              List
            </h4>
      ...
      {cat === "Prefix Sum" &&
        (title.includes("Subarray Sum") || title.includes("HashMap")) && (
          <div className="mt-8">
            <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
              <span className="text-pink-400">▶</span> Interactive Subarray Sum
              K
            </h4>
      ...
      {cat === "Prefix Sum" &&
        (title.includes("Product") || title.includes("Except Self")) && (
          <div className="mt-8">
            <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
              <span className="text-violet-400">▶</span> Interactive Product
              Except Self
            </h4>
      ...
      {cat === "Sliding Window" &&
        (title.includes("Fixed") || title.includes("Maximum Sum")) && (
          <div className="mt-8">
            <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
      ...
      {cat === "Sliding Window" &&
        (title.includes("Longest Substring") ||
          title.includes("Without Repeating")) && (
          <div className="mt-8">
            <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
              <span className="text-purple-400">▶</span> Interactive Longest
              Substring
            </h4>
      ...
      {cat === "Sliding Window" &&
        (title.includes("Anagram") || title.includes("Frequency Counter")) && (
          <div className="mt-8">
            <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
      ...
      {cat === "Stack / Monotonic Stack" &&
        title.includes("Interactive") &&
        title.includes("Largest Rectangle") && (
          <div className="mt-8">
      ...
      {cat === "Union-Find" &&
        title.includes("Interactive") &&
        title.includes("Connected Components") && (
          <div className="mt-8">
      ...
      {cat === "Binary Search" &&
        title.includes("Interactive") &&
        title.includes("Binary Search Visualizer") && (
          <div className="mt-8">
      ...
      {cat === "Binary Search" &&
        title.includes("Interactive") &&
        title.includes("Binary Search on Answer") && (
          <div className="mt-8">
    ...
    <article className="scroll-mt-24" id={`section-${sectionIndex}`}>
      ...
      <div className="pl-7">
        <div className="tutorial-content">
          <ReactMarkdown
            ...
            components={{
              ...
              li: ({ children, ...props }) => {
                const isOrdered =
                  props.node?.position && props.node.position.start.column > 1;
                return (
              ...
              code: ({ className, children, ...props }) => {
                ...
                if (isBlock) {
                  ...
                  const detectLanguage = (
                    code: string
                  ): { lang: string; label?: string } | null => {
                    // Java-specific patterns (type declarations, generics, etc.)
                    if (
                      code.match(
                        /\b(int|boolean|void|public|private|String|Integer|Map<|List<|new \w+\()\b/
                      ) ||
                    ...
                    if (
                      code.match(/\bdef\s+\w+\s*\(/) ||
                      code.includes("elif ") ||
                      code.match(/^\s*(import|from)\s+\w+/m) ||
                      code.includes("self.")
                    ) {
                      return { lang: "python" };
                    }
                  ...
                  const hasKnownLanguage =
                    language && knownLanguages.includes(language.toLowerCase());
              ...
              td: ({ children }) => (
                <td className="px-5 py-4 text-gray-300 text-sm">{children}</td>
              ),
              blockquote: ({ children }) => (
        ...
        {section.approaches && availableApproaches.length > 0 && (
          <div className="mt-8">
            <h4 className="text-base font-semibold text-gray-300 mb-3">
              Example: {section.exampleName || "Code"}
            </h4>
            {/* Approach Tabs */}
            <div className="flex flex-wrap items-center gap-2 mb-3">
