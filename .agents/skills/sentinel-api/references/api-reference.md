...
Base URL: `https://sentinel.deepsource.com/api/v1`
...
Syncs upload code to Sentinel. A sync creates a signed upload URL for uploading a git bundle.
...
Responses include:
- `Sentinel-Version` — API version date (e.g., `2025-09-16`)
- `Sentinel-Workspace-ID` — Workspace ID
